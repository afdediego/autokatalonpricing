...
WebUI.waitForElementPresent(findTestObject('Pricing-Test Plan Regresión Core/Page_POLITICAS/span_Kilometraje'), 5)

WebUI.verifyElementPresent(findTestObject('Pricing-Test Plan Regresión Core/Page_POLITICAS/span_Kilometraje'), 5)

WebUI.click(findTestObject('Pricing-Test Plan Regresión Core/Page_POLITICAS/span_Kilometraje'))

WebUI.waitForElementPresent(findTestObject('Pricing-Test Plan Regresión Core/Page_POLITICAS/span_VisualizarmodificarKilom'), 
    5)

WebUI.verifyElementPresent(findTestObject('Pricing-Test Plan Regresión Core/Page_POLITICAS/span_VisualizarmodificarKilom'), 5)

WebUI.click(findTestObject('Pricing-Test Plan Regresión Core/Page_POLITICAS/span_VisualizarmodificarKilom'))
...
WebUI.waitForElementPresent(findTestObject('Pricing-Test Plan Regresión Core/Page_POLITICAS/h3_Política de kilometraje'), 
    5)

WebUI.verifyElementPresent(findTestObject('Pricing-Test Plan Regresión Core/Page_POLITICAS/h3_Política de kilometraje'), 
    5)
