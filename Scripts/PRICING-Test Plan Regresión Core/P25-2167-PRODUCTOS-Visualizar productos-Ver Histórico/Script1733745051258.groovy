...
WebUI.waitForElementPresent(findTestObject('Pricing-Test Plan Regresión Core/Page_Visualizar PRODUCTOS/div_Cdigo'), 5)

WebUI.waitForElementPresent(findTestObject('Pricing-Test Plan Regresión Core/Page_Visualizar PRODUCTOS/div_Opciones'), 5)

WebUI.waitForElementPresent(findTestObject('Pricing-Test Plan Regresión Core/Page_Visualizar PRODUCTOS/button_Filtros'), 
    5)

WebUI.waitForElementPresent(findTestObject('Pricing-Test Plan Regresión Core/Page_Visualizar PRODUCTOS/IconHistorico'), 
    5)

WebUI.doubleClick(findTestObject('Pricing-Test Plan Regresión Core/Page_Visualizar PRODUCTOS/IconHistorico'))

WebUI.waitForElementPresent(findTestObject('Object Repository/Pricing-Test Plan Regresión Core/Page_Visualizar PRODUCTOS/h5_Histrico de producto'), 
    4)

WebUI.waitForElementPresent(findTestObject('Object Repository/Pricing-Test Plan Regresión Core/Page_Visualizar PRODUCTOS/IconoOjoHist'), 
    4)

WebUI.doubleClick(findTestObject('Object Repository/Pricing-Test Plan Regresión Core/Page_Visualizar PRODUCTOS/IconoOjoHist'))

WebUI.takeScreenshot('P-25-2167')
