...
WebUI.waitForElementPresent(findTestObject('Pricing-Test Plan Regresión Core/Page_CANAL/span_TRADUCCIONES'), 5)

WebUI.verifyElementPresent(findTestObject('Pricing-Test Plan Regresión Core/Page_CANAL/span_TRADUCCIONES'), 5)

WebUI.click(findTestObject('Pricing-Test Plan Regresión Core/Page_CANAL/span_TRADUCCIONES'))

WebUI.waitForElementPresent(findTestObject('Pricing-Test Plan Regresión Core/Page_CANAL/span_VisualizarmodificarTraducciones'), 
    5)

WebUI.verifyElementPresent(findTestObject('Pricing-Test Plan Regresión Core/Page_CANAL/span_VisualizarmodificarTraducciones'), 
    5)

WebUI.click(findTestObject('Pricing-Test Plan Regresión Core/Page_CANAL/span_VisualizarmodificarTraducciones'))
