...
WebUI.waitForElementPresent(findTestObject('Pricing-Test Plan Regresión Core/Page_CANAL/span_TTCC'), 5)

WebUI.verifyElementPresent(findTestObject('Pricing-Test Plan Regresión Core/Page_CANAL/span_TTCC'), 5)

WebUI.click(findTestObject('Pricing-Test Plan Regresión Core/Page_CANAL/span_TTCC'))

WebUI.waitForElementPresent(findTestObject('Pricing-Test Plan Regresión Core/Page_CANAL/span_VisualizarmodificarTTCC'), 
    5)

WebUI.verifyElementPresent(findTestObject('Pricing-Test Plan Regresión Core/Page_CANAL/span_VisualizarmodificarTTCC'), 5)

WebUI.click(findTestObject('Pricing-Test Plan Regresión Core/Page_CANAL/span_VisualizarmodificarTTCC'))
