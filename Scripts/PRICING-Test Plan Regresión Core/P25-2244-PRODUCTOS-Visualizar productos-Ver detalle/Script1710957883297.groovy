...
WebUI.waitForElementPresent(findTestObject('Pricing-Test Plan Regresión Core/Page_Visualizar PRODUCTOS/IconoOjoProduct'), 
    4)

WebUI.doubleClick(findTestObject('Pricing-Test Plan Regresión Core/Page_Visualizar PRODUCTOS/IconoOjoProduct'))

WebUI.waitForElementPresent(findTestObject('Pricing-Test Plan Regresión Core/Page_Visualizar PRODUCTOS/h3_Mostrar Producto'), 
    3)

WebUI.takeScreenshot('P-25-2244')

WebUI.click(findTestObject('Pricing-Test Plan Regresión Core/Page_Visualizar PRODUCTOS/ExpandDatosBasicosProduct'))
