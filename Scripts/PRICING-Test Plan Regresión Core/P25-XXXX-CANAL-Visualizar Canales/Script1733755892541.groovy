...
WebUI.waitForElementPresent(findTestObject('Pricing-Test Plan Regresión Core/Page_CANAL/span_TiposSellCode - Copy'), 5)

WebUI.verifyElementPresent(findTestObject('Pricing-Test Plan Regresión Core/Page_CANAL/span_TiposSellCode - Copy'), 5)

WebUI.click(findTestObject('Pricing-Test Plan Regresión Core/Page_CANAL/span_TiposSellCode - Copy'))

WebUI.waitForElementPresent(findTestObject('Pricing-Test Plan Regresión Core/Page_CANAL/span_VisualizarmodificarCanales'), 
    5)

WebUI.verifyElementPresent(findTestObject('Pricing-Test Plan Regresión Core/Page_CANAL/span_VisualizarmodificarCanales'), 
    5)

WebUI.click(findTestObject('Pricing-Test Plan Regresión Core/Page_CANAL/span_VisualizarmodificarCanales'))
