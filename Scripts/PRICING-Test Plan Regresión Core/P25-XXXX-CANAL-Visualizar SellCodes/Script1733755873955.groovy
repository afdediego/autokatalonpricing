...
WebUI.waitForElementPresent(findTestObject('Pricing-Test Plan Regresión Core/Page_CANAL/span_SellCode'), 5)

WebUI.verifyElementPresent(findTestObject('Pricing-Test Plan Regresión Core/Page_CANAL/span_SellCode'), 5)

WebUI.click(findTestObject('Pricing-Test Plan Regresión Core/Page_CANAL/span_SellCode'))

WebUI.waitForElementPresent(findTestObject('Pricing-Test Plan Regresión Core/Page_CANAL/span_VisualizarmodificarSellCode'), 
    5)

WebUI.verifyElementPresent(findTestObject('Pricing-Test Plan Regresión Core/Page_CANAL/span_VisualizarmodificarSellCode'), 
    5)

WebUI.click(findTestObject('Pricing-Test Plan Regresión Core/Page_CANAL/span_VisualizarmodificarSellCode'))
