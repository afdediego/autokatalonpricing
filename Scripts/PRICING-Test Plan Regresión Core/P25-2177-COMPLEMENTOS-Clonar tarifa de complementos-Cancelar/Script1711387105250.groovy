...
WebUI.waitForElementPresent(findTestObject('Object Repository/Pricing-Test Plan Regresión Core/Page_Visualizar COMPLEMENTOS/span_Tarifa de complemento'), 
    5)

WebUI.verifyElementPresent(findTestObject('Object Repository/Pricing-Test Plan Regresión Core/Page_Visualizar COMPLEMENTOS/span_Tarifa de complemento'), 
    5)

WebUI.click(findTestObject('Object Repository/Pricing-Test Plan Regresión Core/Page_Visualizar COMPLEMENTOS/span_Tarifa de complemento'))

WebUI.waitForElementPresent(findTestObject('Object Repository/Pricing-Test Plan Regresión Core/Page_Visualizar COMPLEMENTOS/span_Visualizarmodificar_TarifaCompl'), 
    5)

WebUI.verifyElementPresent(findTestObject('Object Repository/Pricing-Test Plan Regresión Core/Page_Visualizar COMPLEMENTOS/span_Visualizarmodificar_TarifaCompl'), 
    5)

WebUI.click(findTestObject('Object Repository/Pricing-Test Plan Regresión Core/Page_Visualizar COMPLEMENTOS/span_Visualizarmodificar_TarifaCompl'))
...
WebUI.takeScreenshot('P-25-2175')
