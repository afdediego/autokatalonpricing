...
WebUI.verifyElementPresent(findTestObject('Pricing-Test Plan Regresión Core/Page_Visualizar COMPLEMENTOS/Button_Filtros_Desplegable'), 
    5)
...
WebUI.waitForElementPresent(findTestObject('Pricing-Test Plan Regresión Core/Page_Visualizar COMPLEMENTOS/h3_Complemento'), 
    5)

WebUI.verifyElementPresent(findTestObject('Pricing-Test Plan Regresión Core/Page_Visualizar COMPLEMENTOS/h3_Complemento'), 
    5)

WebUI.waitForElementPresent(findTestObject('Object Repository/Pricing-Test Plan Regresión Core/Page_Visualizar COMPLEMENTOS/a_Ir al listado'), 
    5)

WebUI.verifyElementPresent(findTestObject('Object Repository/Pricing-Test Plan Regresión Core/Page_Visualizar COMPLEMENTOS/a_Ir al listado'), 
    5)

WebUI.focus(findTestObject('Pricing-Test Plan Regresión Core/Page_Visualizar COMPLEMENTOS/a_Ir al listado'))

WebUI.click(findTestObject('Object Repository/Pricing-Test Plan Regresión Core/Page_Visualizar COMPLEMENTOS/a_Ir al listado'))
