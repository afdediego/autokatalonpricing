...
WebUI.waitForElementPresent(findTestObject('Pricing-Test Plan Regresión Core/Page_POLITICAS/span_Modificaciones'), 5)

WebUI.verifyElementPresent(findTestObject('Pricing-Test Plan Regresión Core/Page_POLITICAS/span_Modificaciones'), 5)

WebUI.click(findTestObject('Pricing-Test Plan Regresión Core/Page_POLITICAS/span_Modificaciones'))

WebUI.waitForElementPresent(findTestObject('Pricing-Test Plan Regresión Core/Page_POLITICAS/span_VisualizarmodificarMod'), 
    5)

WebUI.verifyElementPresent(findTestObject('Pricing-Test Plan Regresión Core/Page_POLITICAS/span_VisualizarmodificarMod'), 
    5)

WebUI.click(findTestObject('Pricing-Test Plan Regresión Core/Page_POLITICAS/span_VisualizarmodificarMod'))
...
WebUI.waitForElementPresent(findTestObject('Pricing-Test Plan Regresión Core/Page_POLITICAS/h3_Política de modificación'), 
    5)

WebUI.verifyElementPresent(findTestObject('Pricing-Test Plan Regresión Core/Page_POLITICAS/h3_Política de modificación'), 
    5)
